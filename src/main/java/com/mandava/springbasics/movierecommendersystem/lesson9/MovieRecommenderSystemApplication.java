...
public class MovieRecommenderSystemApplication {
	...
	public static void main(String[] args) {
		...
		// ApplicationContext manages the beans and the dependencies
		...
		System.out.println("ContentBasedFilter with Singleton scope: " + filter);
		
		// Retrieve and print prototype bean from singleton bean multiple times
